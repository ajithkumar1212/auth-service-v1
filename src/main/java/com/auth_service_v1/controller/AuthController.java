...
import com.auth_service_v1.dto.auth.RefreshTokenRequest;
...
public class AuthController {
  ...
  public AuthController(
      IOtpService otpService, IJwtService jwtService, AuthenticationManager authenticationManager) {
  ...
  public ResponseEntity<AuthResponse> refreshToken(
    ...
    Authentication authentication =
        authenticationManager.authenticate(
            new RefreshTokenAuthenticationToken(request.getRefreshToken()));
    return ResponseEntity.ok(jwtService.generateAuthorizationToken(authentication));
  }
}
